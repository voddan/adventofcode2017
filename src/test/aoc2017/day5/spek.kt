...
class Test : Spek({
    ...
    given("2st task") {
        it("escapes from `0, 3, 0, 1, -3` in 10 steps") {
            assertEquals(10, taskB(listOf(0, 3, 0, 1, -3)))
        }
